...
(F1 = array(1:30, dim = c(5,2,3)));str(F1)
(G1 = array(matrix(c(1,3,4,10,10,20,2,1)),dim=c(2,2,2)));str(G1)
(H1 = array(matrix(c(1,3,4,10,10,20,2,'1'),ncol=2),dim=c(2,2,2)));str(H1)
(x5 = array(c(1,5,9,7,5,3,6,9,8,2,2,8),dim=c(2,2,2)))
(x5 = array(c(1,5,9,7,5,3,6,9,8,2,2,8),dim=c(2,3,4)))
x5[,,2]
is.matrix(x5[,,2])
x5[,,2][1,3]
is.vector(x5[,,2][1,3])
